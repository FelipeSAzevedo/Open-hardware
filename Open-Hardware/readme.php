...
<body>
    ...
    <p class="readme">Usuários convidados (que não possuem senha), podem navegar livremente ao site, no entanto, não poderão acessar a aba "Perfil", nem adicionar itens ao carrinho.
    </p>
    ...
    <div class="produtos">
        <div class="produto">
            ...
            <p class="descricao">Fonte XPG Core Reactor 850W 80 Plus blablabla bla bla blablabla Plus blablabla bla bla blablabla</p>
            <p>R$: 29.90</p>
            <button class="comprar_btn_pai">
